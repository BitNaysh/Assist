        ...
        <div className = {styles.cloud}>
          ...
          {messages.map((message, index) => {
            ...
            />
              ...
              <p>Powered by <a href = "https://github.com/hwchase17/langchain" target="_blank">LangChain</a>. Built by <a href="https://twitter.com/chillzaza_" target="_blank">Sanket</a>.</p>
              </div> */}
          </div>
        </main>
